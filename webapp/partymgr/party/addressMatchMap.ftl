...
<div id="address-match-map" class="screenlet">
  <div class="screenlet-title-bar">
    <ul>
      ...
      <li><a href="<@noerpUrl>findAddressMatch</@noerpUrl>">${uiLabelMap.PageTitleFindMatches}</a></li>
    </ul>
    <br class="clear"/>
  </div>
  <div class="screenlet-body">
    <form name="addaddrmap" method="post" action="<@noerpUrl>createAddressMatchMap</@noerpUrl>">
    ...
    <table class="basic-table" cellspacing="0">
      <tr><td colspan="2">&nbsp;</td></tr>
        <tr>
          <td></td>
          <td>
            <form name="importaddrmap" method="post" enctype="multipart/form-data" action="<@noerpUrl>importAddressMatchMapCsv</@noerpUrl>">
      ...
      <#if addressMatchMaps?has_content>
        <table class="basic-table hover-bar" cellspacing="0">
          <tr class="header-row">
            ...
            <td class="button-col"><a href="<@noerpUrl>clearAddressMatchMap</@noerpUrl>">${uiLabelMap.CommonClear} ${uiLabelMap.CommonAll}</a></td>
          </tr>
          ...
          <#list addressMatchMaps as map>
            <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
              ...
              <td class="button-col"><a href="<@noerpUrl>removeAddressMatchMap?mapKey=${map.mapKey}&amp;mapValue=${map.mapValue}</@noerpUrl>">${uiLabelMap.CommonDelete}</a></td>
            </tr>
