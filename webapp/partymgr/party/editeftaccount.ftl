...
<div class="screenlet">
  ...
  <div class="screenlet-body">
        <div class="button-bar">
          <a href="<@noerpUrl>${donePage}?partyId=${partyId}</@noerpUrl>" class="smallSubmit">${uiLabelMap.CommonCancelDone}</a>
          <a href="javascript:document.editeftaccountform.submit()" class="smallSubmit">${uiLabelMap.CommonSave}</a>
        </div>
    <#if !eftAccount??>
      <form method="post" action='<@noerpUrl>createEftAccount?DONE_PAGE=${donePage}</@noerpUrl>' name="editeftaccountform" style='margin: 0;'>
    <#else>
      <form method="post" action='<@noerpUrl>updateEftAccount?DONE_PAGE=${donePage}</@noerpUrl>' name="editeftaccountform" style='margin: 0;'>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="<@noerpUrl>editcontactmech</@noerpUrl>" class="smallSubmit">
      ...
      <div class="button-bar">
        <a href="<@noerpUrl>backHome</@noerpUrl>" class="smallSubmit">${uiLabelMap.CommonCancelDone}</a>
        <a href="javascript:document.editeftaccountform.submit()" class="smallSubmit">${uiLabelMap.CommonSave}</a>
      </div>
  </div>
</div>
