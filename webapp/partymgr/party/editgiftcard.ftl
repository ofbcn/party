...
<div class="screenlet">
  ...
  <div class="screenlet-body">
    <#if !giftCard??>
      <form method="post" action="<@noerpUrl>createGiftCard?DONE_PAGE=${donePage}</@noerpUrl>" name="editgiftcardform" style="margin: 0;">
    <#else>
      <form method="post" action="<@noerpUrl>updateGiftCard?DONE_PAGE=${donePage}</@noerpUrl>" name="editgiftcardform" style="margin: 0;">
