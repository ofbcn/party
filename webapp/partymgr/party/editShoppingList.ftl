...
<div class="screenlet">
  <div class="screenlet-title-bar">
    <ul>
      ...
      <li>
        <form id="createEmptyShoppingList" action="<@noerpUrl>createEmptyShoppingList</@noerpUrl>" method="post">
  ...
  <div class="screenlet-body">
    <#if shoppingLists?has_content>
      <form name="selectShoppingList" method="post" action="<@noerpUrl>editShoppingList</@noerpUrl>">
...
<div class="screenlet">
  ...
  <div class="screenlet-body">
    <form name="updateList" method="post" action="<@noerpUrl>updateShoppingList</@noerpUrl>">
      <input type="hidden" name="shoppingListId" value="${shoppingList.shoppingListId}" />
      ...
      <table class="basic-table" cellspacing='0'>
        ...
        <tr>
          ...
          <td>
            ...
            <#if parentShoppingList??>
              <a href="<@noerpUrl>editShoppingList?shoppingListId=${parentShoppingList.shoppingListId}</@noerpUrl>" class="smallSubmit">${uiLabelMap.CommonGotoParent} (${parentShoppingList.listName?default(parentShoppingList.shoppingListId)})</a>
            </#if>
          </td>
        </tr>
...
<div class="screenlet">
  <div class="screenlet-title-bar">
    <ul>
      ...
      <li><a href="<@noerpUrl>addListToCart?shoppingListId=${shoppingList.shoppingListId}&amp;includeChild=yes</@noerpUrl>">${uiLabelMap.PartyAddChildListsToCart}</a></li>
    </ul>
    <br class="clear"/>
  </div>
  <div class="screenlet-body">
    <table class="basic-table" cellspacing="0">
      ...
      <#list childShoppingListDatas as childShoppingListData>
        ...
        <tr>
          <td class="button-col"><a href="<@noerpUrl>editShoppingList?shoppingListId=${childShoppingList.shoppingListId}</@noerpUrl>">${childShoppingList.listName?default(childShoppingList.shoppingListId)}</a></li>
          <td class="button-col align-float">
            <a href="<@noerpUrl>editShoppingList?shoppingListId=${childShoppingList.shoppingListId}</@noerpUrl>">${uiLabelMap.PartyGotoList}</a>
            <a href="<@noerpUrl>addListToCart?shoppingListId=${childShoppingList.shoppingListId}</@noerpUrl>">${uiLabelMap.PartyAddListToCart}</a>
          </td>
        </tr>
      </#list>
    </table>
  ...
  <div class="screenlet-title-bar">
    <ul>
      <li class="h3">${uiLabelMap.PartyListItems} - ${shoppingList.listName}</li>
        <#-- <li><a href="<@noerpUrl>addListToCart?shoppingListId=${shoppingList.shoppingListId}</@noerpUrl>">${uiLabelMap.PartyAddListToCart}</a></li> -->
    </ul>
    <br class="clear"/>
  </div>
  <div class="screenlet-body">
    <#if shoppingListItemDatas?has_content>
        ...
        <#assign viewIndexLast = Static["org.noerp.base.util.UtilMisc"].getViewLastIndex(listSize, viewSize) />
        <#assign messageMap = Static["org.noerp.base.util.UtilMisc"].toMap("lowCount", lowIndex, "highCount", highIndex, "total", listSize)/>
        <#assign commonDisplaying = Static["org.noerp.base.util.UtilProperties"].getMessage("CommonUiLabels", "CommonDisplaying", messageMap, locale)/>
      ...
      <table class="basic-table" cellspacing="0">
        ...
        <#list shoppingListItemDatas[lowIndex-1..highIndex-1] as shoppingListItemData>
          ...
          <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
            ...
            <form method="post" action="<@noerpUrl>removeFromShoppingList</@noerpUrl>" name='removeform_${shoppingListItem.shoppingListItemSeqId}'>
              <input type="hidden" name="shoppingListId" value="${shoppingListItem.shoppingListId}" />
              <input type="hidden" name="shoppingListItemSeqId" value="${shoppingListItem.shoppingListItemSeqId}" />
            </form>
            <form method="post" action="<@noerpUrl>updateShoppingListItem</@noerpUrl>" name='listform_${shoppingListItem.shoppingListItemSeqId}'>
              <input type="hidden" name="shoppingListId" value="${shoppingListItem.shoppingListId}" />
              <input type="hidden" name="shoppingListItemSeqId" value="${shoppingListItem.shoppingListItemSeqId}" />
              <td>
            ...
            <td class="align-float"><@noerpCurrency amount=unitPrice isoCode=currencyUomId/></td>
            <td class="align-float"><@noerpCurrency amount=totalPrice isoCode=currencyUomId/></td>
            <td class="button-col align-float">
...
<div class="screenlet">
  ...
  <div class="screenlet-body">
    <form name="addToShoppingList" method="post" action="<@noerpUrl>addItemToShoppingList</@noerpUrl>">
      <input type="hidden" name="shoppingListId" value="${shoppingList.shoppingListId}" />
      <input type="hidden" name="partyId" value="${shoppingList.partyId!}" />
