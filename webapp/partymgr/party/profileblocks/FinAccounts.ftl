...
<div style="border-bottom: 1px solid #ccc; margin-bottom: 20px">
    ...
    <p>
        ...
        <#if ownedFinAccount.replenishLevel??>
            <b>${uiLabelMap.FormFieldTitle_replenishLevel}:</b> <@noerpCurrency amount=ownedFinAccount.replenishLevel isoCode=ownedFinAccount.currencyUomId/>
        </#if>
    </p>
    <br />
        ...
        <tbody>
            <#list ownedFinAccountTransList as ownedFinAccountTrans>
                ...
                <tr>
                    ...
                    <td><@noerpCurrency amount=displayAmount isoCode=ownedFinAccount.currencyUomId/></td>
                </tr>
            </#list>
        </tbody>
        <tfoot>
            ...
            <tr>
                ...
                <td><b><@noerpCurrency amount=ownedFinAccount.actualBalance isoCode=ownedFinAccount.currencyUomId/></b></td>
            </tr>
        </tfoot>
    </table>
</div>
            ...
            <tbody>
                <#list ownedFinAccountAuthList as ownedFinAccountAuth>
                    <tr>
                        ...
                        <td><@noerpCurrency amount=-ownedFinAccountAuth.amount isoCode=ownedFinAccount.currencyUomId/></td>
                    </tr>
                </#list>
            </tbody>
            <tfoot>
                ...
                <tr>
                    ...
                    <td><b><@noerpCurrency amount=ownedFinAccount.availableBalance isoCode=ownedFinAccount.currencyUomId/></b></td>
                </tr>
            </tfoot>
        </table>
    </div>
