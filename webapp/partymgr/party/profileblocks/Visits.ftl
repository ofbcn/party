  ...
  <div id="partyVisits" class="screenlet">
    <div class="screenlet-title-bar">
      <ul>
        ...
        <li><a href="<@noerpUrl>findVisits?partyId=${partyId}</@noerpUrl>">${uiLabelMap.CommonListAll}</a></li>
      </ul>
      <br class="clear" />
    </div>
        ...
        <table class="basic-table" cellspacing="0">
          ...
          <#list visits as visitObj>
            <#if (visitObj_index > 4)><#break></#if>
              <tr>
                <td class="button-col">
                  <a href="<@noerpUrl>visitdetail?visitId=${visitObj.visitId!}</@noerpUrl>">${visitObj.visitId!}</a>
                </td>
