    ...
    <div class="screenlet-title-bar">
      <ul>
        ...
        <#if security.hasEntityPermission("PAY_INFO", "_CREATE", session) || security.hasEntityPermission("ACCOUNTING", "_CREATE", session)>
          <li><a href="<@noerpUrl>editeftaccount?partyId=${partyId}</@noerpUrl>">${uiLabelMap.AccountingCreateNewEftAccount}</a></li>
          <li><a href="<@noerpUrl>editgiftcard?partyId=${partyId}</@noerpUrl>">${uiLabelMap.AccountingCreateNewGiftCard}</a></li>
          <li><a href="<@noerpUrl>editcreditcard?partyId=${partyId}</@noerpUrl>">${uiLabelMap.AccountingCreateNewCreditCard}</a></li>
          <li><a href="<@noerpUrl>EditBillingAccount?partyId=${partyId}</@noerpUrl>">${uiLabelMap.AccountingCreateBillingAccount}</a></li>
        </#if>
      </ul>
      <br class="clear" />
    </div>
      ...
      <#if paymentMethodValueMaps?has_content || billingAccounts?has_content>
          ...
          <#list paymentMethodValueMaps as paymentMethodValueMap>
            ...
            <tr>
              <#if "CREDIT_CARD" == paymentMethod.paymentMethodTypeId && paymentMethodValueMap.creditCard?has_content>
                ...
                <td class="button-col">
                  ...
                  <#if security.hasEntityPermission("PAY_INFO", "_UPDATE", session) || security.hasEntityPermission("ACCOUNTING", "_UPDATE", session)>
                    <a href="<@noerpUrl>editcreditcard?partyId=${partyId}&amp;paymentMethodId=${paymentMethod.paymentMethodId}</@noerpUrl>">${uiLabelMap.CommonUpdate}</a>
                  </#if>
                <#-- </td> -->
              <#elseif "GIFT_CARD" == paymentMethod.paymentMethodTypeId>
                ...
                <td class="button-col">
                  <#if security.hasEntityPermission("PAY_INFO", "_UPDATE", session) || security.hasEntityPermission("ACCOUNTING", "_UPDATE", session)>
                    <a href="<@noerpUrl>editgiftcard?partyId=${partyId}&amp;paymentMethodId=${paymentMethod.paymentMethodId}</@noerpUrl>">${uiLabelMap.CommonUpdate}</a>
                  </#if>
                <#-- </td> -->
              <#elseif "EFT_ACCOUNT" == paymentMethod.paymentMethodTypeId>
                ...
                <td class="button-col">
                  <#if security.hasEntityPermission("PAY_INFO", "_UPDATE", session) || security.hasEntityPermission("ACCOUNTING", "_UPDATE", session)>
                    <a href="<@noerpUrl>editeftaccount?partyId=${partyId}&amp;paymentMethodId=${paymentMethod.paymentMethodId}</@noerpUrl>">${uiLabelMap.CommonUpdate}</a>
                  </#if>
                <#-- </td> -->
              ...
              <#if security.hasEntityPermission("PAY_INFO", "_DELETE", session) || security.hasEntityPermission("ACCOUNTING", "_DELETE", session)>
                <a href="<@noerpUrl>deletePaymentMethod/viewprofile?partyId=${partyId}&amp;paymentMethodId=${paymentMethod.paymentMethodId}</@noerpUrl>">${uiLabelMap.CommonExpire}</a>
              <#else>
                &nbsp;
              </#if>
        ...
        <#if billingAccounts?has_content>
            ...
            <tr>
              ...
              <td class="button-col">
                <a href="<@noerpUrl>EditBillingAccount?billingAccountId=${billing.billingAccountId}&amp;partyId=${partyId}</@noerpUrl>">${uiLabelMap.CommonUpdate}</a>
                <a href="<@noerpUrl>deleteBillingAccount?partyId=${partyId}&amp;billingAccountId=${billing.billingAccountId}</@noerpUrl>">${uiLabelMap.CommonExpire}</a>
              </td>
          </tr>
          </#list>
        </#if>
