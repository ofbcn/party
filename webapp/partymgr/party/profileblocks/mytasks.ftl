...
<div class="screenlet">
  <div class="screenlet-title-bar">
    <ul>
      ...
      <li><a href="<@noerpContentUrl>/workeffort/control/EditWorkEffort?workEffortTypeId=TASK&amp;currentStatusId=CAL_NEEDS_ACTION</@noerpContentUrl>">${uiLabelMap.WorkEffortNewTask}</a></li>
    </ul>
    <br class="clear"/>
  </div>
    ...
    <table class="basic-table hover-bar" cellspacing="0">
      ...
      <#list roleActivities as workEffort>
        <tr<#if alt_row> class="alternate-row"</#if>>
          ...
          <td>${workEffort.roleTypeId}</td>
          <td><a href="<@noerpContentUrl>/workeffort/control/WorkEffortSummary?workEffortId=${workEffort.workEffortId}</@noerpContentUrl>">${workEffort.workEffortName}</a></td>
          <td class="button-col"><a href="<@noerpContentUrl>/workeffort/control/acceptRoleAssignment?workEffortId=${workEffort.workEffortId}&amp;partyId=${workEffort.partyId}&amp;roleTypeId=${workEffort.roleTypeId}&amp;fromDate=${workEffort.fromDate.toString()}</@noerpContentUrl>">${uiLabelMap.WorkEffortAcceptAssignment}&nbsp;[${workEffort.workEffortId}]</a></td>
        </tr>
        <#assign alt_row = !alt_row>
      </#list>
    </table>
    ...
    <table class="basic-table hover-bar" cellspacing="0">
      ...
      <#list groupActivities as workEffort>
        <tr<#if alt_row> class="alternate-row"</#if>>
          ...
          <#-- <td>${workEffort.roleTypeId}</td> -->
          <td><a href="<@noerpContentUrl>/workeffort/control/WorkEffortSummary?workEffortId=${workEffort.workEffortId}</@noerpContentUrl>">${workEffort.workEffortName}</a></td>
          <td class="button-col"><a href="<@noerpContentUrl>/workeffort/control/acceptassignment?workEffortId=${workEffort.workEffortId}&amp;partyId=${workEffort.partyId}&amp;roleTypeId=${workEffort.roleTypeId}&amp;fromDate=${workEffort.fromDate}</@noerpContentUrl>">${uiLabelMap.WorkEffortAcceptAssignment}&nbsp;[${workEffort.workEffortId}]</a></td>
        </tr>
        <#assign alt_row = !alt_row>
      </#list>
    </table>
