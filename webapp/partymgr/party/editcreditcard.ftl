...
<div class="screenlet">
  ...
  <div class="screenlet-body">
    ...
    <#if !creditCard??>
      <form method="post" action="<@noerpUrl>createCreditCard?DONE_PAGE=${donePage}</@noerpUrl>" name="editcreditcardform" style="margin: 0;">
    <#else>
      <form method="post" action="<@noerpUrl>updateCreditCard?DONE_PAGE=${donePage}</@noerpUrl>" name="editcreditcardform" style="margin: 0;">
