...
<div id="address-match-map" class="screenlet">
  <div class="screenlet-title-bar">
    <ul>
      ...
      <li><a href="<@noerpUrl>addressMatchMap</@noerpUrl>">${uiLabelMap.PageTitleAddressMatchMap}</a></li>
    </ul>
    <br class="clear"/>
  </div>
  <div class="screenlet-body">
    <table class="basic-table" cellspacing="0">
      <form name="matchform" method="post" action="<@noerpUrl>findAddressMatch?match=true</@noerpUrl>">
        <tr>
              ...
              <table cellspacing="0" class="basic-table">
                ...
                <#list matches as match>
                  ...
                  <tr>
                    ...
                    <td class="button-col"><a href="<@noerpUrl>viewprofile?partyId=${match.partyId}</@noerpUrl>">${match.partyId}</a></td>
                  </tr>
                </#list>
              </table>
            <#else>
